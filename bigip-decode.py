...
def get_host(c_host) -> str:
    ...
    # @ds: make conversion a bit more dynamic
    xhosts = [int(dh_host[pos], 16) for pos in range(len(dh_host))]
    # print out the ip address
    # @ds: make a bit more streamlines
...
def main():
    ...
    # split the cookie into 3 parts, splitting at the '.'
    # we don't need the c_end parameter
    # @ds: so we are not even parsing it out
